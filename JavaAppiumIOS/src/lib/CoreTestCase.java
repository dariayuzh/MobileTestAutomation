...
public class CoreTestCase extends TestCase {
    ...
    private DesiredCapabilities getCapabilitiesByPlatformEnv() throws Exception {
        ...
        if (platform.equals(PLATFORM_ANDROID)) {
            ...
            throw new Exception("Cannot set platform capabilities by env value. Platform value = " + platform);
        }
    ...
    private AppiumDriver getDriverByPlatformEnv(DesiredCapabilities capabilities) throws Exception {
        ...
        if (platform.equals(PLATFORM_ANDROID)) {
            ...
            throw new Exception("Cannot get platform driver by env value. Platform value = " + platform);
        }
    }
}
